  ...
  return (
    <div className="container">
      ...
      <ul>
        ...
        <li>Grâce au fichier globals.css, mettre le texte des labels en bleu, agrandir la police dans les input texte, placer un
      ...
      <form method="post" action="/api/register">
        ...
        <div>
          <label className="form-label" htmlFor="cgu">CGU</label>
